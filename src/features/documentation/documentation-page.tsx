...
export function DocumentationPage({
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[radial-gradient(circle_at_top_left,rgba(59,130,246,0.14),transparent_36%),radial-gradient(circle_at_top_right,rgba(14,165,233,0.10),transparent_28%),linear-gradient(to_bottom,hsl(var(--background)),hsl(var(--muted)/0.35))]">
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-450 gap-6 px-4 py-4 sm:px-6 lg:px-8">
        ...
        <main className="min-w-0 flex-1">
          <div className="mb-6 rounded-[28px] border border-border/70 bg-background/75 px-6 py-6 shadow-[0_24px_80px_-40px_rgba(15,23,42,0.45)] backdrop-blur-xl sm:px-8">
          ...
          <div className="flex items-start gap-6">
            <div className="min-w-0 flex-1 rounded-[28px] border border-border/70 bg-background/85 px-5 py-6 shadow-[0_24px_80px_-48px_rgba(15,23,42,0.48)] backdrop-blur-xl sm:px-8 sm:py-8">
